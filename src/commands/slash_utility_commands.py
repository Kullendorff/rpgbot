...
Konverterar prefix commands (!help, !stats) till moderna slash commands.
"""
...
async def register_slash_utility_commands(bot, roll_tracker, color_handler, embed_factory):
    ...
    print("Slash utility commands har registrerats (/help, /stats, /mystats, /allstats, /mystatsall).")